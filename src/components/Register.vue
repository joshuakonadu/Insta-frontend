<template>
  <div class="container-fluid d-flex">
    <div class="row flex-grow-1">
      <div
        class="col-lg-4 col-xl-4 d-none d-lg-flex align-items-center gradient-bg full-height px-0"
      >
      ...
      <div class="col-md-8 col-lg-8 col-xl-8 flex-center mt-3">
        <div class="registercom p-sm-2">
          <div class="mb-7">
            <h1 class="text-primary font-weight-normal mb-1">
              Willkommen be <strong>Insta</strong>
            </h1>
            <p>
          ...
          <form @submit.prevent="submit" action="/register" method="post">
            <div class="form-group">
              ...
              <input
                ...
                :class="{
                  'is-invalid': $v.email.$error && email_flag == false,
                  'is-valid': !$v.email.$invalid && email_flag == false
                }"
            ...
            <div class="form-group">
              ...
              <div class="invalid-feedback" v-if="!$v.password.minLength">
                Ihr Passwort ist zu kurz. Mindestens
                {{ $v.password.$params.minLength.min }} Zeichen
              </div>
            </div>
            <div class="form-group">
              ...
              <input
                ...
                aria-label="Passwort"
                required
                :class="{ 'is-invalid': $v.passwordcnf.$error }"
              />
              <div
                class="invalid-feedback"
                v-if="!$v.passwordcnf.sameAsPassword"
              >
            ...
            <div class="js-form-message mb-5">
              <div
                class="custom-control custom-checkbox reg d-flex align-items-center text-muted"
              >
                <input
                  v-model="checkbox"
                  type="checkbox"
                ...
                <label class="custom-control-label" for="termsCheckbox">
                  <small>
                    ...
                    <a
                      class="link-muted"
                      href="https://www.verlingo.de/impressum/"
                      target="_blank"
                      >AGB</a
                    >
                    und
                    <a
                      class="link-muted"
                      href="https://www.verlingo.de/datenschutz-talentscout/"
                      target="_blank"
